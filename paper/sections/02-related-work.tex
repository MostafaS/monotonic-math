...
REIT distribution & Required by tax structure & Required by contract constant & Distribution enforced by an on-chain redemption primitive, not a corporate intermediary (deployment-jurisdiction analysis required; see \S\ref{sec:lim-regulatory}) \\
